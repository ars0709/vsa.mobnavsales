...
{
    [Activity(Label = "NavOffModeCompany")]
    public class NavOffModeCompany : Activity
    {
        ...
        private void LoadDetail()
        {
            try
            {
                EditText xtxtcompanyname = FindViewById<EditText>(Resource.Id.txtcompanyname );
                EditText xtxtwserver = FindViewById<EditText>(Resource.Id);
                EditText xtxtwport = FindViewById<EditText>(Resource.Id.txtport);
